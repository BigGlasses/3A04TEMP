...
import static com.mcmaster3a04.team11.audiovally.Data.Constants.gnUser;
...
public class AudioInput extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        statusview = findViewById(R.id.app_status);
        ...
        try {
            ...
            gnMusicIdStream = new GnMusicIdStream(Constants.gnUser, GnMusicIdStreamPreset.kPresetMicrophone, new AudioInput.MusicIDStreamEvents());
        ...
        public void musicIdStreamAlbumResult(GnResponseAlbums result, IGnCancellable canceller ) {
            ...
            try {
                ...
                if(result.resultCount() > 0 && result.albums().count() > 0){
                    ...
                    GnAlbum a = result.albums().at(0).next();

                    Constants.setAlbum(a);
...
//                    String genre = result.albums().at(0).next().genre(GnDataLevel.kDataLevel_1);
//                    Log.d("Pizza Test", genre);
    ...
    class AudioVisualizeAdapter implements IGnAudioSource {
        ...
        public long getData(ByteBuffer buffer, long bufferSize) {
            ...
            if (numBytes != 0) {
                ...
                Log.d("Pizza Pie", "" + rms_percent);
                ImageView a = findViewById(R.id.centerpiece);
                a.setScaleX(1 + ((float)rms_percent)*0.25f );
                a.setScaleY(1 + ((float)rms_percent)*0.25f );
...
//                }
    ...
    private class BundleIngestEvents implements IGnLookupLocalStreamIngestEvents {
        ...
        public void statusEvent(GnLookupLocalStreamIngestStatus status, String bundleId, IGnCancellable canceller) {
            Log.i("kekkk", "Bundle ingest progress: " +  status.toString());
        }
    }
